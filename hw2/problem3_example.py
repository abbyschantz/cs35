...
#
#     Who will win the superbowl last weekend... ?
#
#         Note: not limited to last weekend's teams!
...
def get_team_colors_page(team):
    """ get_team_colors_page takes in a string with a "city-mascot" formatted team name
        such as atlanta-falcons or carolina-panthers
...
def extract_team_colors(soup):
    ...
    for div in AllDivs:
        ...
        # example:   Broncos Orange Hex Color: #FB4F14; RGB: (251,79,20)
        Words = div.text.split()  
        # gets all of the words, e.g., ['Red', 'Hex', 'Color:', '#A6192D;', 'RGB:', '(189,13,24)']
        # find the word "Hex"
        if "Hex" in Words:
            hex_index = Words.index("Hex")
            color = Words[ hex_index-1 ]  # it's the one BEFORE!
...
def main():
    ...
    """
    # team_1 = 'carolina-panthers'  # 2016
    # team_2 = 'denver-broncos'     # 2016
